$(document).ready(function(){
    ...
    function createRanking(solutions){
        ...
        for(var i = 0 ; i < solutions.length ; i++){
            ...
            if(!groups.has(solutions[i].group_id)){
                groups.set(solutions[i].group_id, {
        ...
        // console.log(ranking_tsp1);
        // console.log(ranking_tsp2);
        // console.log(ranking_tsp3);

        // Evaluate the score of each group
        for(var i = 0 ; i < ranking_tsp1.length ; i++){
            var current_group = groups.get(ranking_tsp1[i].group_id);
